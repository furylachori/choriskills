...
Environment:
    ...
    OUTPUT_DIR - Optional. Output directory for transcript (default: $HOME/.zeroclaw/agents/default/workspace/output)
"""
...
def transcribe_audio(args):
    ...
    try:
        ...
        with _urlopen_with_retry(req, timeout=args.timeout, opener=opener) as response:
            buffer = b""
            max_empty_reads = 3
            empty_reads = 0
